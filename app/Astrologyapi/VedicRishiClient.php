...
*/
    ...
    public function matchBirthDetails(array $maleBirthData, array $femaleBirthData)
    {
        ...
        $response = Helper::getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    /*public function getNumeroGemSuggestion($date, $month, $year, $name)
    {
        ...
        $data = $this->packageNumeroData($date, $month, $year, $name);
        $response = Helper::getCurlReponse($this->userId, $this->apiKey, $resourceName, $data);
        return $response;
    }*/
    ...
    public function timezoneWithDst( $date, $latitude, $longitude)
    {
        ...
        $resData = Helper::getCurlReponse($this->userId, $this->apiKey,$resourceName, $data,$this->language);
        return $resData;
    }
    ...
    public function getWesternHoroscope($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $settings = array()){
        ...
        $response = Helper::getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, 'en');
        return $response;
    ...
    public function callApi($endPoint, $data){
        $response = Helper::getCurlReponse($this->userId, $this->apiKey, $endPoint, $data, $this->language);
        return $response;
    }
